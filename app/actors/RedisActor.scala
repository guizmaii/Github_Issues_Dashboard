...
class RedisActor extends Actor with ActorLogging {
  ...
  override def receive: Receive = {
    ...
    case g1Data: G1ComputedData =>
      ...
      G1Redis setOldestIssueCreationDate TimeHelper.dateTimeToTimestamp(new DateTime(findOldestIssueCreationDate).minusDays(2))
  ...
  def findOldestIssueCreationDate: Long = {
    ...
    DB.withTransaction(
      implicit t =>
        G1Redis getAll GithubRepositoryDAO.getAll map {
          data =>

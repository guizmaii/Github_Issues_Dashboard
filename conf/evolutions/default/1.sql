...
create table "REPOS" ("ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"OWNER" VARCHAR NOT NULL,"NAME" VARCHAR NOT NULL,"IS_FETCHED_IN_REDIS" BOOLEAN NOT NULL);
